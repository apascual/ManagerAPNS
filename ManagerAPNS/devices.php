...
<script type="text/javascript">
	...
	function sendDevelopment() {
		...
		if($someSelected)
		{
			...
			$.post("include/sendDevelopment.php", {
				"pid":PIDOfSelectedDevice.substring(0, PIDOfSelectedDevice.length-1)
			}, function(data) {
				if(data)
				{
...
<div class="hero-unit">
	<h2>Devices List<small> For <?= $_GET['appname'] ?></small></h2>
</div>
...
<div class="row-fluid">
 <div class="well">
	<p>
		<a class="btn btn-primary" onclick="openModal()" data-toggle="modal">Push devices</a>
		<a class="btn btn-primary" onclick="sendDevelopment()">Sandbox/production</a>
		<a class="btn" onclick="sendFetch()">Send Fetch</a>
		<a class="btn" onclick="sendFlush()">Send Flush</a>
	</p>
	</div>
	...
	<tbody>
		...
		<tr>
			...
			<td class="hidden-phone"><?= $value['created'] ?></td>
